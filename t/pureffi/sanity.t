...
=== TEST 15: get_keys() with some keys
--- http_config eval: $::HttpConfig
--- config
    location = /t {
        content_by_lua_block {
...
=== TEST 17: get_keys() filled lru-cache
--- http_config eval: $::HttpConfig
--- config
    location = /t {
        content_by_lua_block {
...
=== TEST 20: get_keys() user-fed res table
--- http_config eval: $::HttpConfig
--- config
    location = /t {
        content_by_lua_block {
...
=== TEST 21: get_keys() user-fed res table + max_count
--- http_config eval: $::HttpConfig
--- config
    location = /t {
        content_by_lua_block {
